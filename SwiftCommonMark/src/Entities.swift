...
//
/*
 Based on entities.inc generated by make_entities_inc.py.
 https://github.com/commonmark/cmark/blob/master/src/entities.inc
 https://github.com/commonmark/cmark/blob/master/tools/make_entities_inc.py
 */

import Foundation

typealias CmarkEntityNode = (name: String, characters: String)

let CMARK_ENTITY_MIN_LENGTH = 2
let CMARK_ENTITY_MAX_LENGTH = 32
let CMARK_NUM_ENTITIES = cmark_entities.count

let cmark_entities: [CmarkEntityNode] = [
    ("AElig", "\u{00C6}"),
    ("AMP", "\u{0026}"),
    ("Aacute", "\u{00C1}"),
    ("Abreve", "\u{0102}"),
